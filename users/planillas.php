        ...
        <div id="datos_buscador" class="container">
            <table class="table">
                <div style="display:inline-block;" class="d-grid gap-2 d-md-flex justify-content-md-end">
                    ...
                    ?>
                        <a class="btn btn-secondary" href="add.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
